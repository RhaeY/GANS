...
def train():
    ...
    seed = tf.random.normal([42, latent_dim])
    ...
    for epoch in range(epochs):
        ...
        print('Total Time for epoch {} is {} sec - gen_loss = {}, disc_loss = {}'.format(epoch + 1, time.time() - start, total_gen_loss / batch_size, total_disc_loss / batch_size))
